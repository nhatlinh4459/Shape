				...
				for(int j = 0; j < this.list.size(); j++)
				{
					if(j!=thisRect)
					{
						...
						if(another.shading(temp))//co override nhau
						{
							...
							{
								if((another.UpperBound(x, y1)&&temp.UpperBound(x, y1)))
									check1=check1;
								else if((another.LowerBound(x, y1)&&temp.LowerBound(x, y1)))
									check1=check1;
								else if((another.RightBound(x, y1)&&temp.RightBound(x, y1)))
									check1=check1;
								else if((another.LeftBound(x, y1)&&temp.LeftBound(x, y1)))
									check1=check1;
								else
									check1++;
							}
							...
							{
								if((another.UpperBound(x, y2)&&temp.UpperBound(x, y2)))
									check2=check2;
								else if((another.LowerBound(x, y2)&&temp.LowerBound(x, y2)))
									check2=check2;
								else if((another.RightBound(x, y2)&&temp.RightBound(x, y2)))
									check2=check2;
								else if((another.LeftBound(x, y2)&&temp.LeftBound(x, y2)))
									check2=check2;
								else
									check2++;
							}
						...
						{
							if(another.nextToBound(x, y1))
							{
								if(!temp.isCorner(x, y1))
									check1++;
							}
							if(another.nextToBound(x, y2))
							{
								if(!temp.isCorner(x, y2))
									check2++;
							}
						}
					}
				...
				for(int j = 0; j < this.list.size(); j++)
				{
					if(j!=thisRect)
					{
						...
						if(another.shading(temp))//co override nhau
						{
							...
							{
								if((another.UpperBound(x1, y)&&temp.UpperBound(x1, y)))
									check1=check1;
								else if((another.LowerBound(x1, y)&&temp.LowerBound(x1, y)))
									check1=check1;
								else if((another.RightBound(x1, y)&&temp.RightBound(x1, y)))
									check1=check1;
								else if((another.LeftBound(x1, y)&&temp.LeftBound(x1, y)))
									check1=check1;
								else
									check1++;
							}
							...
							{
								if((another.UpperBound(x2, y)&&temp.UpperBound(x2, y)))
									check2=check2;
								else if((another.LowerBound(x2, y)&&temp.LowerBound(x2, y)))
									check2=check2;
								else if((another.RightBound(x2, y)&&temp.RightBound(x2, y)))
									check2=check2;
								else if((another.LeftBound(x2, y)&&temp.LeftBound(x2, y)))
									check2=check2;
								else
									check2++;
							}
						...
						{
							if(another.nextToBound(x1, y))
							{
								if(!temp.isCorner(x1, y))
									check1++;
							}
							if(another.nextToBound(x2, y))
							{
								if(!temp.isCorner(x2, y))
									check2++;
							}
						}
					}
